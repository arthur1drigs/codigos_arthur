...
valor_dollar = float(input("Digite o valor em dollar a ser convetido para real:"))
conversao = valor_dollar * cotacao_dollar
print(f"seu dollar em real vai dar {conversao} ")
